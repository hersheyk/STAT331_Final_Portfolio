...
**WD-1:** Lab 4 second intro code chunk(labeled 'here') + Practice Activity Military load- in chunk
...
**WD-7**: **Pivot wider:** Lab 9 code chunk 2: "summarize"**Pivot longer:** Preview Activity Cereal, code chunk 1
...
**DVS-2 & DVS**-**3**: Lab 9; Section Summarizing & Visualizing the Number of Allisons

**DVS-4**: I can calculate numerical summaries of variables.

**DVS-5:** Lab 3 Question 6(code chunk 6: demographics)

**DVS-6 & DVS**-**7:** Challenge 9, Section: Allison Table
