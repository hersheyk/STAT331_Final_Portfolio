...
5.  Careful! Only variables go inside aes()! Hard coded values like alpha = 0.1 go outside because they are not variables.
...
8.  Your boxplots should only have two variables, weight and species. The jittered points should be on top of the boxplots.
    ...
    You've plotted a scatterplot on top of boxplots, which is not the intention of the plot.
...
10. What are these species of???
    ...
    Please revise this plot to reflect the changes you made earlier.

G

11. I don't see the x and y variables swapped in your plot.
...
For number 10, it was more of a continued misunderstanding regarding the x and y axes, so once I figured out 8, it was easy to fix 10.

For 11, I was more confused regarding the x and y axes switching because in the faceted plots there were so many graphs I didn't understand what the end result was supposed to be.
